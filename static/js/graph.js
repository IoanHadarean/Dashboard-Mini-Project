...
function makeGraphs(error, salaryData) {
    ...
    salaryData.forEach(function(d) {
        ...
        d.yrs_service = parseInt(d["yrs.service"]); //wrapping in square brackets because there is already "." in "yrs.srvice"
    });
...
function show_service_to_salary_correlation(ndx) {
    ...
    var minExperience = yearsOfServiceDim.bottom(1)[0].yrs_service;
    var maxExperience = yearsOfServiceDim.top(1)[0].yrs_service;
